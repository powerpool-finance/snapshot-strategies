...
async function strategy(space, network, provider, addresses, options, snapshot) {
    ...
    const response = await (0, utils_1.call)(provider, abi, [contractAdress, 'getNames', [addresses]], { blockTag });
    const r = Object.fromEntries(response.map((value, i) => {
        const isEligible = value !== '' &&
            eth_ens_namehash_1.default.normalize(value) === value &&
