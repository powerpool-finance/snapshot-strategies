...
async function strategy(space, network, provider, addresses, options, snapshot) {
    ...
    const cardBalancePromises = [];
    Object.keys(curioAddresses).forEach((cardName) => cardBalancePromises.push(returnPromiseWithContext((0, erc20_balance_of_1.strategy)(space, network, provider, addresses, { address: curioAddresses[cardName], decimals: 0, start: 3678637 }, snapshot), cardName)));
